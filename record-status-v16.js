(() => {
  ...
  window.openCase = async function openCaseWithRecordStatus(id, adminMode) {
    ...
    buttons.forEach((button, index) => {
      ...
      if (record.locked) {
        button.innerHTML = `${day}일차<br><small style="font-size:11px;font-weight:700">기록완료 · 서명완료 ✓</small>`;
      } else {
        button.innerHTML = `${day}일차<br><small style="font-size:11px;font-weight:700">기록완료 · 미서명</small>`;
